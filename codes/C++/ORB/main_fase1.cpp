...
int main()
{
    ...
    outputVideo.open(NAME, VideoWriter::fourcc('M','J','P','G'), 30.0, Size(640, 480), true);
    ...
    Mat frame;
    namedWindow("Video", 1);
    video_in >> frame; // primera instancia
    ...
    while (waitKey(30 ))
    {
        ...
        if( c_input == 'q' | c_input == ((char)27) ) return 0; // Mostrar l
        imshow("Video", frame);
        video_in >> frame;
    }
    */
